...
bt14=Button(frame1,text='智育成绩数据库操作')
...
fr14=LabelFrame(relief=GROOVE,text='智育数据库操作：')
L15 = Label(fr14,text='f4') 
L15.pack()
...
bt24=Button(frame2,text='综测数据库操作')
...
fr24=LabelFrame(relief=GROOVE,text='综测数据库操作：')
L25 = Label(fr24,text='f4') 
L25.pack()
